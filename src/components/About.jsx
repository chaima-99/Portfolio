    ...
    <section id="about" className="min-h-screen overflow-hidden flex items-center justify-center text-white px-4 sm:px-6">
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <figure data-aos="fade-right" data-aos-delay='500' className="flex flex-wrap justify-center gap-4 relative">
                ...
                <img src={imgabout1} alt="About Image" className="absolute -top-2 left-5 sm:left-10 transform -translate-y-12 z-20 w-24 h-24 sm:w-32 sm:h-32 rounded-3xl shadow-lg" />
                <img src={imageAbout} alt="About Image" className="relative z-10 w-36 h-44 sm:w-40 md:w-72 md:h-96 rounded-lg shadow-lg " />
            ...
            <article data-aos="fade-left" data-aos-delay='500' className="ftext-center lg:text-left relative">
                <div className="absulote z-0 w-40 h-40 sm:w-60 sm:h-60 bg-[#cd3cf5] rounded-full blur-3xl opacity-50 -top-5 left-10"></div>
                <header>
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">About Me</h1>
                </header>
                <p className="text-base sm:text-lg md:text-xl text-gray-300mb-6 sm:mb-8 leading-relaxed">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae reprehenderit voluptates doloribus quidem facere nesciunt blanditiis hic beatae doloremque minima!
                </p>
                <footer>
